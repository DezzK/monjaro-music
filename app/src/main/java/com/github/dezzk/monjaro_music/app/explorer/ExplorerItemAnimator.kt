 ...
 * copied from jp.wasabeef:recyclerview-animators (SlideInLeftAnimator)
 */


open class ExplorerItemAnimator : BaseItemAnimator2 {
	constructor()
...
abstract class BaseItemAnimator2 : SimpleItemAnimator() {
	...
	inner class DefaultAddAnimatorListener(private var viewHolder: RecyclerView.ViewHolder) :
	...
	protected inner class DefaultRemoveAnimatorListener(private var viewHolder: RecyclerView.ViewHolder) :
		AnimatorListenerAdapter() {
		override fun onAnimationStart(animator: Animator) {
